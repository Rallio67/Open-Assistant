...
# You may use whatever tokenizer you like, but if you are generating a set of prompts it is helpful to have them be the same number of tokens. Different tokenizers will not generate the same number of tokens.
...
print(len(tokenizer.encode(rosey_prompt1)))
...
print(len(tokenizer.encode(rosey_prompt2)))
...
print(len(tokenizer.encode(rosey_prompt3)))
...
print(len(tokenizer.encode(rosey_prompt4)))
